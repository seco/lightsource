...
void initButton(Adafruit_GFX_AS *gfx, int16_t x, int16_t y,
...
class GFXcanvas1 : public Adafruit_GFX_AS {
public:
...
class GFXcanvas16 : public Adafruit_GFX_AS {
